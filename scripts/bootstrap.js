...
packages.forEach(({shortName, name, pkg, pkgPath}) => {
    ...
    if (args.force || !pkg) {
      const json = {
        ...
        homepage: `https://github.com/feroomjs/feroomjs/tree/main/packages/${shortName}#readme`
      }
      ...
      out.success(`✅ package.json created`)
        ...
        if (pkg.name !== name || pkg.version !== version) {
          ...
          pkg.homepage = `https://github.com/feroomjs/feroomjs/tree/main/packages/${shortName}#readme`
